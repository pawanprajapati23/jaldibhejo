    ...
    <div {...getRootProps()} className="glass-panel w-full p-8 md:p-12 flex flex-col items-center justify-center min-h-[500px] outline-none">
      ...
      {connectionState === "waiting" && role === "sender" && (
        <div className="text-center w-full max-w-sm">
          ...
          <div className="flex items-center bg-background border border-border rounded-xl p-2 pl-4 mb-8 text-left overflow-hidden">
            ...
            <div className="flex items-center gap-1">
              <a
                ...
                className="p-2 bg-surface hover:bg-[#25D366]/10 hover:text-[#25D366] rounded-lg transition-colors"
